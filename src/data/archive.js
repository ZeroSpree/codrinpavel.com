export default function () {
  // tags: featured, fortune, award, report, media, nonprofit, independent

  return [
    {
      client: "Confidential Client",
      type: "Suite of ESG Reports",
      projects: [
        {
          year: 2026,
    ...
    },
    {
      ...
      projects: [
        ...
        {
          year: 2024,
          project: "Materiality and Stakeholder Engagement",
          tags: ["report"],
    ...
    {
      client: "NRMP",
      type: "Healthcare Platform & Directory",
      projects: [
        {
          year: 2024,
    ...
    {
      client: "FNIH",
      type: "Award-Winning Annual Reports",
      projects: [
        {
          year: 2022,
          project: "2021 Annual Report",
    ...
    {
      client: "AGCO",
      type: "Interactive Annual Reports",
      projects: [
        {
          year: 2021,
          project: "2020 Annual Report",
    ...
    {
      client: "Tradeweb",
      type: "Annual Report & Investor Relations",
      projects: [
        {
          year: 2020,
          project: "2019 Annual Report",
    ...
    },
    {
      ...
      type: "Suite of non-profit websites",
      projects: [
        {
          year: 2020,
    ...
    {
      client: "GSK",
      type: "Flonase campaign websites",
      projects: [
        {
          year: 2017,
